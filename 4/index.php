            ...
            <div class="w3-white w3-text-grey w3-card-4">
                ...
                <div class="w3-container">
                    ...
                    <?php foreach ($skills as $skill):?>
                        <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i><?php echo $skill["name"]?></b></p>
                        <p><?php echo $skill["name"]?></p>
                        <div class="w3-light-grey w3-round-xlarge w3-small">
                            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?php echo $skill["percent"]?>%">
